...
tput setaf 3; tput cup 1 0; echo "Ingrese el nombre del usuario a modificar: "
tput setaf 7; tput cup 1 43; read nomUsu
...
do
	tput cup 11 0; echo "                                                          "
	tput cup 14 0; tput setaf 1; echo "Opcion incorrecta!"
...
then
	...
	case $opcion2 in
		...
		"A") 
			...
			tput cup 22 0; tput setaf 2; echo "Grupo del usuario '$nomUsu' modificado correctamente!"
